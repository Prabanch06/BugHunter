...
const mockUsageOverTime = [
  { name: 'Mon', inputTokens: 4000, outputTokens: 2400, cost: 0.12 },
  { name: 'Tue', inputTokens: 3000, outputTokens: 1398, cost: 0.08 },
  { name: 'Wed', inputTokens: 2000, outputTokens: 9800, cost: 0.24 },
  { name: 'Thu', inputTokens: 2780, outputTokens: 3908, cost: 0.15 },
  { name: 'Fri', inputTokens: 1890, outputTokens: 4800, cost: 0.13 },
  { name: 'Sat', inputTokens: 2390, outputTokens: 3800, cost: 0.11 },
  { name: 'Sun', inputTokens: 3490, outputTokens: 4300, cost: 0.18 },
];
  ...
  return (
    <div className="space-y-6 flex flex-col h-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard title="Total Tokens (30d)" value="2.4M" subtitle="1.8M In / 600K Out" icon={<Cpu className="text-blue-500" />} />
        <StatCard title="API Requests (30d)" value="1,248" subtitle="Avg 41/day" icon={<Activity className="text-emerald-500" />} />
        <StatCard title="Est. Cost (30d)" value="$7.84" subtitle="Current billing cycle" icon={<DollarSign className="text-amber-500" />} />
        <StatCard title="Quota Status" value="Healthy" subtitle="12% of monthly limit" icon={<CreditCard className="text-indigo-500" />} />
      </div>
        ...
        <div className="lg:col-span-2 bg-white border border-slate-200 rounded-xl flex flex-col shadow-sm overflow-hidden p-6">
          ...
          <div className="flex-1 w-full min-h-[0]">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={mockUsageOverTime} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                <defs>
