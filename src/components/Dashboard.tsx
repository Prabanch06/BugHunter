  ...
  return (
    <div className="space-y-6 flex flex-col h-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard label="Total Scans" value={history.length} change="↑ 2 from yesterday" changeColor="text-green-600" />
        <StatCard label="Bugs Detected" value="12" change="5 High Priority" changeColor="text-amber-600" valueColor="text-amber-600" />
        <StatCard label="Vulnerabilities" value="3" change="Require immediate action" changeColor="text-red-600 underline" borderLeft="border-l-4 border-l-red-500" valueColor="text-slate-900" labelColor="text-red-500" />
        <StatCard label="Security Score" value="84" valueSuffix="/100" change="Stable" changeColor="text-slate-500" valueColor="text-green-600" isScore />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm">
          <div className="flex justify-between items-center mb-6">
            ...
            <span className="text-xs bg-amber-100 text-amber-700 px-2 py-1 rounded font-semibold">Total: 26</span>
          </div>
          <div className="h-48">
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm">
          <div className="flex justify-between items-center mb-6">
            ...
            <span className="text-xs bg-green-100 text-green-700 px-2 py-1 rounded font-semibold">+8 pts</span>
          </div>
          <div className="h-48">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={mockChartData} margin={{ top: 5, right: 0, left: -20, bottom: 0 }}>
...
function StatCard({ label, value, change, changeColor, valueColor = "text-slate-900", labelColor = "text-slate-400", borderLeft, valueSuffix, isScore }: StatCardProps) {
  return (
    <div className={`bg-white p-5 border border-slate-200 rounded-xl shadow-sm ${borderLeft || ''}`}>
